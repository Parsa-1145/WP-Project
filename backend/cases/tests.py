...
class CaseCreationTest(APITestCase):
    ...
    def test_complaint_creation(self):
        ...
        self.assert_type_keys(self.u1, {"COMPLAINT", "BAIL_REQUEST", "DATA_REWARD"})
        self.assert_type_keys(self.u2, {"COMPLAINT", "BAIL_REQUEST", "DATA_REWARD"})
        self.assert_type_keys(self.u3, {"COMPLAINT", "CRIME_SCENE", "BAIL_REQUEST", "DATA_REWARD"})
    ...
    def test_case_assignment_test(self):
        ...
        # suspects are proposed via investigation-approval submissions.
        crime_scene_case.refresh_from_db()
        self.assertSetEqual(
        ...
        res = self.send_submission(
            ...
            {
                "case": crime_scene_case.pk,
                "suggested_suspects_national_ids": ["2222222222", "3333333333"],
            },
        )
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        ...
        self.assertIsNotNone(case_json)
        suspects_json = case_json["suspects"]
        self.assertEqual(
